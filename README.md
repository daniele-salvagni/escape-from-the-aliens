...
![Cubic Coordinates](http://i.imgur.com/czmpVwF.png)
...
![State Machine Graph](http://i.imgur.com/2ZeBlCv.png)
*The State Machine that handles actions and turn sequences. Blue and orange transitions could also lead to the end of a game (`FinishedState`).*
